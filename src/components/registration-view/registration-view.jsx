    ...
    <Card className="box-shadow">
      ...
      <Form>
        ...
        <Form.Group controlId="formUsername" className="reg-form-inputs">
          ...
          <Form.Control className="inputFont" type="text" value={username} onChange={e => setUsername(e.target.value)} />
            {values.usernameErr && <p>{values.usernameErr}</p>}
        </Form.Group>

        <Form.Group controlId="formPassword" className="reg-form-inputs">
          <Form.Label>Password:</Form.Label>
          <Form.Control className="inputFont" type="password" value={password} onChange={e => setPassword(e.target.value)} />
          {values.passwordErr && <p>{values.passwordErr}</p>}
        </Form.Group>

        <Form.Group controlId="formEmail" className="reg-form-inputs">
          <Form.Label>Email:</Form.Label>
          <Form.Control className="inputFont" type="email" value={email} onChange={e => setEmail(e.target.value)} />
